    ...
    const handleAdd = async (e) => {
        ...
        try {
            const res = await axios.post("/tasks", {
                title,
                description,
                due_date: "2024-08-10T00:00:00.000Z" // Adjust according to your app's logic
            }, {
                headers: {
                    Authorization: `Bearer ${userToken}`
                }
                ...
                <form onSubmit={handleAdd}>
                    <div>
                        ...
                        <input
                            ...
                            required
                            onChange={(e) => setTitle(e.target.value)}
                            className=' border border-gray-300 bg-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </div>
                    <div className='my-3'>
                        <label htmlFor="description">Description</label>
                        <textarea
                    ...
                    <div className='flex justify-center'>
                        <button
                            type='submit'
                            className=' bg-[#39A5ED] rounded-md text-white px-5 py-1 '
                        >Add</button>
                    </div>
                </form>
                <div className="toast bg-green-600 text-white p-3 rounded-xl shadow-2xl text-center absolute bottom-4 left-1/2 -translate-x-1/2" id='toast'>
